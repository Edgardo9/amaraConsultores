...
@Component({
  ...
  templateUrl: './ivanti.component.html',
  styleUrl: './ivanti.component.css'
})
   ...
   section1: iSection[] = [
    {
      ...
      textDesc: "Atiende integralmente las necesidades de descubrimiento, gestión, aseguramiento y servicio en las áreas de tecnología."
    },
    {
      ...
      textDesc: "Proporciona una vista de 360 grados de dispositivos, usuarios, aplicaciones y servicios, con datos en tiempo real."
    },
    {
      ...
      textDesc: "Detecta, descubre y remedia continuamente las amenazas a la seguridad."
    },
    {
      ...
      textDesc: "Proporciona información en tiempo real, obteniendo mejores resultados con más velocidad, precisión y eficiencia."
    }
  ];
  ...
  section2: iSection[] = [
    {
      ...
      textDesc: "Ofrece bots para detectar, diagnosticar y corregir automáticamente y mantener el cumplimiento de los dispositivos."
    },
    {
      ...
      textDesc: "Entrega información de activos precisa y procesable en minutos."
    },
    {
      ...
      textDesc: "Información sobre el entorno de software, optimizando el rendimiento de activos."
    },
    {
